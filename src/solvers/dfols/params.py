...
class ParameterList(object):
    def __init__(self, n, npt, maxfun, objfun_has_noise=False, dynamic_accuracy=False):
        self.params = {}
        ...
        self.params["general.accept_any_decrease"] = False if dynamic_accuracy else True  # set kopt to best value so far (regardless of how found)
        self.params["general.dynamic_accuracy_delta_factor"] = 10.0  # use accuracy factor*delta^2 for dynamic accuracy evaluations
        # Initialisation
        self.params["init.random_initial_directions"] = True if npt > (n+1)*(n+2)//2 else False  # only if coord directions not available
        ...
        self.params["tr_radius.eta1_prime"] = 0.05
    ...
    def param_type(self, key, npt):
        ...
        elif key == "general.accept_any_decrease":
            type_str, nonetype_ok, lower, upper = 'bool', False, None, None
        elif key == "general.dynamic_accuracy_delta_factor":
            type_str, nonetype_ok, lower, upper = 'float', False, 0.0, None
